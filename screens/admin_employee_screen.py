...
class adminemployeeScreen():
    ...
    def add_employees(self, var_test):
        ...
        ui.set_text(self._objects['add_employee_firstname'], var_test.get("firstname"))
        ui.set_text(self._objects['add_employee_lastname'], var_test.get("lastname"))
        ...
        for i in range(1, 10):
            ...
            if employee['my_email'] == str(new_employee.split(" ")[3]):
                ...
                if (employee['active'] == "yes"):
                    if (ui.get_class(self._objects[
                                         'employees_table_active']) == "list-action-enable action-enabled"): check_active = True
                else:
                    if (ui.get_class(self._objects[
                                         'employees_table_active']) == "list-action-enable action-disabled"): check_active = True
