...
class catalogProductScreen():    
    ...
    def __init__(self):
        ...
        if '1.7' in Configuration().version_presta or '17' in Configuration().version_presta:    
            self._objects = {
                        ...
                        'product_table_id_desc' : ("xpath","//form[@id='product_catalog_list']/div[2]/div/table/thead/tr[1]/th[1]/span[2]"),                        
                        'line_product_table' : ("xpath","//form[@id=\"product_catalog_list\"]//div//table//tbody//tr[str(i)]"),
                        'col_line_product_table_first_column' : ("xpath","//form[@id=\"product_catalog_list\"]//div//table//tbody//tr[str(i)]//td[str(j)]/div/label"),
                        'col_line_product_table' : ("xpath","//form[@id=\"product_catalog_list\"]/div/div/table/tbody/tr[str(i)]//td[str(j)]"),
                        ...
                        'product_new_info_features_feature' : ("xpath","//select[@id=\"form_step1_features_str(i)_feature\"]//option[@value='str(j)']"),
                        'product_new_info_features_custom_value' : ("xpath","//input[@id=\"form_step1_features_'str(i)'_custom_value_1\"]"),
                        'product_new_info_features_value' : ("xpath","//select[@id=\"form_step1_features_'str(i)'_value\"]//option[@value=\"str(j)\"]"),
                        ...
                        'product_new_info_sub_category_expand' : ('xpath','//div[@id="form_step1_categories"]/ul/li/ul//li/div/label[text()="test_auto"]/..'),
                        'product_new_info_category_checkbox' : ('xpath','//div[@id="form_step1_categories"]//label[text()="str(i)"]//input'),
                        
                        'product_new_info_default_category' : ("xpath","//select[@id=\"form_step1_id_category_default\"]/option[@value=str(i)]"),
                        'product_new_info_default_category2' : ("xpath","//div[@id=\"form_step1_categories\"]//label[text()='str(i)']//../div/input"),                       
                        'product_new_info_new_category_name' : ('css','#form_step1_new_category_name'),
                        'product_new_info_new_category_parent_category' : ("xpath","//select[@id=\"form_step1_new_category_id_parent\"]/option[text()='str(i)']"),
                        'product_new_info_new_category_save' : ('css','#form_step1_new_category_save'),  
                        'category_name_checkbox' : ("xpath","//input[@name=\"form[step1][categories][tree][]\" and ancestor::label[text()=\"str(i)\"]]"),
                        'category_default_save' : ("xpath","//select[@id=\"form_step1_id_category_default\"]/option[@selected]"),                                              
                        ...
                        'product_new_info_price_priority' : ("xpath","//*[@id=\"form_step2_specificPricePriority_str(i)\"]/option[@value=\"str(j)\"]"),
                        'product_new_info_price_priority_apply_to_all' : ('css','#form_step2_specificPricePriorityToAll'),
                        'product_new_pack_quantity' : ("xpath","//select[@id=\"form_step3_pack_stock_type\"]/option[@value=str(i)]"),
                        'product_new_pack_quantity_check' : ("xpath","//select[@id='form_step3_pack_stock_type']/option[@selected]"),
                        ...
                        'product_new_variation_creation_value' : ("xpath","//div[@class=\"tt-suggestion tt-selectable\" and text()='str(i)']"),
                        ...
                        'product_new_variation_open_close2' : ("xpath","(//button[@class=\"btn btn-tertiary-outline btn-back\"])[str(i)]"),
                        ...
                        'product_new_variation_open_delete' : ("xpath","//tr[@data-index=str(i)]//td//a[@class=\"btn btn-default btn-sm delete\"]"),
                        ...
                        'product_new_variation_wholesale' : ("xpath","//input[@id=\"combination_str(i)_attribute_wholesale_price\"]"),
                        'product_new_variation_price_impact' : ("xpath","//select[@id=\"combination_str(i)_attribute_price_impact\"]//option[@value=str(j)]"),
                        ...
                        'product_new_variation_weight_impact' : ("xpath","//select[@id=\"combination_str(i)_attribute_weight_impact\"]//option[@value=str(j)]"),
                        'product_new_variation_weight' : ("xpath","//input[@id=\"combination_str(i)_attribute_weight\"]"),
                        'product_new_variation_unit_impact' : ("xpath","//select[@id=\"combination_str(i)_attribute_unit_impact\"]//option[@value=str(j)]"),
                        'product_new_variation_unity' : ("xpath","//input[@id=\"combination_str(i)_attribute_unity\"]"),
                        'product_new_variation_minimal_quantity' : ("xpath","//input[@id=\"combination_str(i)_attribute_minimal_quantity\"]"),
                        'product_new_variation_available_date' : ("xpath","//input[@id=\"combination_str(i)_available_date_attribute\"]"),
                        ...
                        'product_new_variation_img_liste' : ("xpath","//div[@id=\"combination_str(i)_id_image_attr\"]//div//input"),
                        'product_new_variation_img_checkbox' : ("xpath","//div[@id=\"combination_str(i)_id_image_attr\"]//div[str(j)]//input"),
                        ...
                        'product_new_carrier' : ("xpath","//div[@id=\"form_step4_selectedCarriers\"]//div//label[contains(text(),'str(i)')]"),
                         'product_new_carrier_check'  : ("xpath","//div[@id=\"form_step4_selectedCarriers\"]//div//label[contains(text(),'str(i)')]/input[@checked]"),
                        ...
                        'product_new_options_visibility' : ("xpath","//select[@id=\"form_step6_visibility\"]//option[@value='str(i)']"),
                        ...
                        'product_new_options_default_supplier' : ("xpath","//select[@id=\"form_step6_default_supplier\"]//option[str(i)]"),
                        'product_new_options_supplier_reference' : ("css","#form_step6_supplier_combination_1_str(i)_supplier_reference"),
                        'product_new_supplier_name_product' : ("xpath","//div[@id=\"supplier_combination_collection\"]/div[2]/div[2]/div/table//tr[str(i)]/td[1]"),
                        'product_new_options_product_price' : ("css","#form_step6_supplier_combination_1_str(i)_product_price"),
                        'product_new_options_price_currency' : ("xpath","//select[@id=\"form_step6_supplier_combination_1_str(i)_product_price_currency\"]//option[str(j)]"),
                        ...
                        'pack_product_quantity' : ("xpath","//*[@id=\"form_step1_inputPackItems-data\"]/li[str(i)]/div/div[@class=\"quantity text-md-right\"]"),
                        
                        'product_new_specific_price_add' : ("xpath","//a[@href='#specific_price_form']"),
                        'product_new_specific_price_shop' : ("xpath","//*[@id=\"form_step2_specific_price_sp_id_shop\"]//option[@value=str(i)]"),
                        'product_new_specific_price_currency' : ("xpath","//*[@id=\"form_step2_specific_price_sp_id_currency\"]//option[@value=str(i)]"),
                        'product_new_specific_price_country' : ("xpath","//*[@id=\"form_step2_specific_price_sp_id_country\"]//option[@value=str(i)]"),
                        'product_new_specific_price_group' : ("xpath","//*[@id=\"form_step2_specific_price_sp_id_group\"]//option[@value=str(i)]"),
                        'product_new_specific_price_variation' : ("xpath","//*[@id=\"form_step2_specific_price_sp_id_product_attribute\"]//option[@value=str(i)]"),
                        ...
                        'product_new_specific_price_reduction_type' : ("xpath","//*[@id=\"form_step2_specific_price_sp_reduction_type\"]//option[@value='str(i)']"),
                        'product_new_specific_price_reduction_tax' : ("xpath","//*[@id=\"form_step2_specific_price_sp_reduction_tax\"]//option[@value=str(i)]"),
                        ...
                        'product_new_personalization_type' : ("xpath","//*[@id=\"form_step6_custom_fields_str(i)_type\"]//option[@value=str(j)]"),
                        ...
                        'catalog_search_id' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div/table/thead/tr[2]/th[1]/input"),
                        'catalog_search_name' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div/table/thead/tr[2]/th[3]/input"),
                        'catalog_search_ref' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div/table/thead/tr[2]/th[4]/input"),
                        'catalog_search_cat' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div/table/thead/tr[2]/th[5]/input"),
                        ...
                        'catalog_search_state' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div/table/thead/tr[2]/th[9]/select/option[@value=str(i)]"),
                        'catalog_filter_reset' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div/table/thead/tr[2]/th[10]/input[2]"),
                        'catalog_go_to_first_page' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div[2]/div/ul[1]/li[1]/a"),
                        'catalog_go_to_last_page' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div[2]/div/ul[1]/li[5]/a"),
                        'catalog_go_to_previous_page' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div[2]/div/ul[1]/li[2]/a"),
                        'catalog_go_to_next_page' : ("xpath","//a[@id='pagination_next_url']"),
                        'catalog_go_to_page_number' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div[2]/div/ul[1]/li[3]/input"),
                        'catalog_number_element_per_page' : ("xpath","//select[@name=\"paginator_select_page_limit\"]/option[@selected]"),
                        'catalog_change_number_element_per_page' : ("xpath","//form[@id=\"product_catalog_list\"]/div[2]/div[2]/div/ul[2]/li/select/option[@value=str(i)]"),
                        ...
                        'col_line_product_table_activate' : ('xpath', '//form[@id=\"product_catalog_list\"]//div//table//tbody//tr[str(i)]//td[str(j)]/a'),
                        'catalog_open_product' : ('xpath', '//form[@id=\"product_catalog_list\"]//div//table//tbody//tr[str(i)]//td[str(j)]/a'),
                        'product_img' : ("xpath","//*[@id=\"product-images-dropzone\"]/div[str(i)]"),
                        

                        'product_new_variation_line_quantity' : ("xpath","(//td[@class=\"attribute-quantity\"]/div/input)[str(i)]"),
                        ...
                        'new_product_default_supplier_check' : ("xpath","//select[@id=\"form_step6_default_supplier\"]//option[@selected]"),
                        'product_new_options_price_currency_check' : ("xpath","//select[@id=\"form_step6_supplier_combination_1_str(i)_product_price_currency\"]//option[@selected]"),
                        'product_tax_rules_listbox_shortcut' :("css","#select2-step2_id_tax_rules_group_rendered-container"),
                        'product_tax_rules_listbox_view_shortcut' :("xpath","//ul[@id=\"select2-step2_id_tax_rules_group_rendered-results\"]/li[str(i)]"),
                        'product_tax_rules_listbox' :("css","#select2-form_step2_id_tax_rules_group-container"),
                        'product_tax_rules_listbox_view' :("xpath","//ul[@id=\"select2-form_step2_id_tax_rules_group-results\"]/li[str(i)]"),
                        "redirection_page_listbox":("css","#select2-form_step5_redirect_type-container"),
                        "redirection_page_listbox_result":("xpath","//ul[@id=\"select2-form_step5_redirect_type-results\"]/li[str(i)]"),
                        ...
                        "product_list_quicknav_id":("xpath","//table[@class=\"table table-condensed table-striped product quicknav-products\"]/tbody/tr[str(i)]/td/a"),
    ...
    def add_product(self,var_test):
        ...
        if '1.6' in Configuration().version_presta:
            ...
            ui.wait_until(self._objects['product_new_wholesale'][1],60,0.25,self._objects['product_new_wholesale'][0])
            ...
            ui.wait_until(self._objects['product_new_Seo_meta_title'][1],60,0.25,self._objects['product_new_Seo_meta_title'][0])
            ...
            if var_test.get("shortlink") != "" : ui.set_text(self._objects['product_new_Seo_short_link'], var_test.get("shortlink"),True)
            ...
            if var_test.get("new_type") == "1":
                if var_test.get('pack')[0]['search'] != "":
                    ...
                    for x_pack in var_test.get('pack'):
                        ...
                        time.sleep(3)
                        my_elem = ui.find_element(self._objects['product_new_pack_search'][0],self._objects['product_new_pack_search'][1])
                        ...
                        var_test['pack_product_name_' + str(i)] = (ui.find_element(pproduit_name[0],pproduit_name[1]).text).split('Size')[0]
                        var_test['pack_product_quantity_' + str(i)] = (ui.find_element(pproduit_quantity[0],pproduit_quantity[1]).text).split('x')[1]      
                        i = i+1
            ...
            if "//" in var_test.get("picture"):
                ...
                for img in var_test.get("picture").split("//"):
                    ...
                    if nb_img ==1:
                        ...
                        img_data_id.append(ui.get_attribute(("xpath","(//div[@class='dz-preview dz-image-preview ui-sortable-handle dz-complete'])"), "data-id"))
                        var_test['img_list'] = ui.get_attribute(("xpath","(//div[@class='dz-preview dz-image-preview ui-sortable-handle dz-complete'])"), "data-id")
                    else:
                        ui.wait_until("(//div[@class='dz-preview dz-image-preview ui-sortable-handle dz-complete'])[" + str(nb_img) + "]", 90, 1)
                        img_data_id.append(ui.get_attribute(("xpath","(//div[@class='dz-preview dz-image-preview ui-sortable-handle dz-complete'])[" + str(nb_img) + "]"), "data-id"))
                        var_test['img_list'] = var_test['img_list'] + "//" + ui.get_attribute(("xpath","(//div[@class='dz-preview dz-image-preview ui-sortable-handle dz-complete'])[" + str(nb_img) + "]"), "data-id")
                    
                var_test['nb_img'] = nb_img
                source = ui.find_element("xpath", "//div[@data-id='" + img_data_id[nb_img-1] + "']")
                x = ui.find_element("xpath", "//div[@data-id='" + img_data_id[0] + "']").location['x'] - ui.find_element("xpath", "//div[@data-id='" + img_data_id[nb_img-1] + "']").location['x'] -10
                y = ui.find_element("xpath", "//div[@data-id='" + img_data_id[0] + "']").location['y'] - ui.find_element("xpath", "//div[@data-id='" + img_data_id[nb_img-1] + "']").location['y'] -10
...
#           
            ...
            if var_test.get('product_category') != "":
                my_category = ui.def_object(self._objects['product_new_info_category_checkbox'],var_test.get('product_category'))
                ui.click(my_category)
                default_category = ui.def_object(self._objects['product_new_info_default_category'],var_test.get('product_category'))
            ...
            if var_test.get('search_related_products')!= "":
                ...
                if "//" in var_test.get("search_related_products"):
                    ...
                    for rel in var_test.get("search_related_products").split("//"):
                        ...
                        my_elem = ui.find_element(self._objects['product_new_related_products_search'][0],self._objects['product_new_related_products_search'][1])
                        time.sleep(3)
                        my_elem.send_keys(Keys.ARROW_DOWN)
                        my_elem.send_keys(Keys.ENTER)
                        my_elem.clear()
                        related_product_name = ui.def_object(self._objects['related_product_info'],i)
                        var_test['related_product_name_' + str(i)] = ui.get_text((related_product_name[0],related_product_name[1])).split('\n')[0]
                        i = i+1
                    var_test['related_product_number'] = i 
                else:
                    ui.set_text(self._objects['product_new_related_products_search'], var_test.get("search_related_products"),True)
                    my_elem = ui.find_element(self._objects['product_new_related_products_search'][0],self._objects['product_new_related_products_search'][1])
                    my_elem.send_keys(Keys.ARROW_DOWN)
                    my_elem.send_keys(Keys.ENTER)
                    my_elem.clear()     
                    related_product_name = ui.def_object(self._objects['related_product_info'],1)
                    var_test['related_product_name_1'] = ui.get_text((related_product_name[0],related_product_name[1])).split(" (")[0] 
            if var_test.get('features')!="":
                ...
                for x_feature in var_test.get('features'):
                    ...
                    feature_option = ui.def_object(self._objects['product_new_info_features_feature'],v,x_feature['feature'])
                    ui.click(feature_option)
                    if x_feature['value'] != "":
                        feature_value = ui.def_object(self._objects['product_new_info_features_value'],v,x_feature['value'])
            ...
            if var_test.get("tax_choosen_shortcut") == "1":
                ...
                tax_rule = ui.def_object(self._objects['product_tax_rules_listbox_view_shortcut'],var_test.get("tax_rule"))
                ui.click(tax_rule)
            ...
            if var_test.get("new_type") == "2":
                if var_test.get("virtual_file") != "":
                    ...
                    time.sleep(3)               
                    ui.upload_file(self._objects['product_new_virtual_file'],var_test.get("virtual_file")[0]['virtual_file'],True)
                    #ui.set_text(self._objects['product_new_virtual_file_name'],var_test.get("virtual_file")[0]['virtual_file_name'])
                    ui.set_text(self._objects['product_new_virtual_file_nb_download'],var_test.get("virtual_file")[0]['virtual_file_nb_download'])
                    ui.set_text(self._objects['product_new_virtual_file_exp_date'],var_test.get("virtual_file")[0]['virtual_file_exp_date'])
                    ui.set_text(self._objects['product_new_virtual_file_nb_days'],var_test.get("virtual_file")[0]['file_nb_days'],True)
            ...
            if var_test.get('variation')!="":
                for x_variation in var_test.get('variation'):
                    for var_x in x_variation['compose'].split('//'):
                        ...
                        my_elem = ui.find_element(self._objects['product_new_variation_creation'][0],self._objects['product_new_variation_creation'][1])
                        my_elem.send_keys(Keys.ARROW_DOWN)
                        my_elem.send_keys(Keys.ENTER)
                        my_elem.clear()
            ...
            if var_test.get('variation')!="":
                ...
                nb_var = len(ui.find_elements(self._objects['product_new_nb_variation'][0],self._objects['product_new_nb_variation'][1]))
                for x_variation in var_test.get('variation'): 
                    ...
                    if w == 1:
                        ...
                        var_test['quantity_totale'] = int(var_test.get('quantity_totale')) + int(x_variation['quantity'])
            ...
            product_out_stock = ui.def_object(self._objects['product_new_quantity_case_out_of_stock'],var_test.get("out_stock"))
            ...
            if var_test.get('price_priority') != "":
                ...
                for priority in var_test.get('price_priority').split('//'):
                    ...
                    ui.click(option)
                    v=v+1
                ui.checkbox(self._objects['product_new_info_price_priority_apply_to_all'],var_test.get('price_priority_to_all'))
            ui.click(self._objects['product_new_save']) 
            ...
            redirection = ui.def_object(self._objects['redirection_page_listbox_result'],var_test.get("redirection_page"))
            ...
            if var_test.get("redirection_page") > str(1):
                ...
                time.sleep(2)
                my_elem = ui.find_element(self._objects['redirection_page_target'][0],self._objects['redirection_page_target'][1])
                my_elem.send_keys(Keys.ARROW_DOWN)
                my_elem.send_keys(Keys.ENTER)
                my_elem.clear()     
            ...
            ui.click(supplier)
            default_supplier = ui.def_object(self._objects['product_new_options_default_supplier'],var_test.get('default_supplier'))
            ...
            if var_test.get('variation')!="":
                ...
                for x_variation in var_test.get('variation'):
                    ...
                    currency = ui.def_object(self._objects['product_new_options_price_currency'],v,x_variation['supplier_product_price_currency'])
                    ui.click(currency)
                    v = v+1
            else:
                ...
                currency = ui.def_object(self._objects['product_new_options_price_currency'],0,var_test.get('price_currency'))
                ui.click(currency)
    ...
    def check_product(self,var_test):    
        for i in range(1,10):
            ...
            if var_test.get('product_name') == str(my_product.split(" ")[0].split("\n")[1]) :
                Test.assert_more_or_equal(var_test.get('old_max_id'), ui.find_element(ui.def_object(self._objects['col_line_product_table_first_column'],i,1)[0],ui.def_object(self._objects['col_line_product_table_first_column'],i,1)[1]).text, "'id product' is not bigger than the previous one", "'id product' is bigger than the previous one")
                Test.assert_equals(str(var_test.get('ref')), ui.find_element(ui.def_object(self._objects['col_line_product_table'],i,4)[0],ui.def_object(self._objects['col_line_product_table'],i,4)[1]).text, "'reference' hasn't the right value", "'reference' is ok")
                check_price = var_test.get("priceTE")
                if "." not in check_price:
                    check_price = check_price + ".00"
                check_price="€" + check_price
                Test.assert_equals(str(check_price), ui.find_element(ui.def_object(self._objects['col_line_product_table'],i,6)[0],ui.def_object(self._objects['col_line_product_table'],i,6)[1]).text.split(" ")[0], "'price' hasn't the right value", "'price' is ok")
                Test.assert_equals(int(var_test.get('quantity_totale')), int(ui.find_element(ui.def_object(self._objects['col_line_product_table'],i,7)[0],ui.def_object(self._objects['col_line_product_table'],i,7)[1]).text), "'quantity' hasn't the right value", "'quantity' is ok")
                
                col_selected = ui.def_object(self._objects['catalog_open_product'],i,2)
                ui.click(col_selected)
                try:
                    Test.assert_equals(var_test.get('product_name'), ui.get_attribute(self._objects["product_new_info_name"],"value"), "'name' not matching", "'name' is ok")
                    if var_test.get("active") == "yes":
                        try:
                            ui.find_element(self._objects['product_new_info_activate_check'][0],self._objects['product_new_info_activate_check'][1])
                        except:
                            raise
                    else:
                        try:
                            ...
                            raise
                    Test.assert_equals(var_test.get('new_type'), ui.find_element('xpath', '//select[@id="form_step1_type_product"]//option[@selected="selected"]/..').get_attribute('value'), "'new_type' not matching", "'new_type' is ok")


                    if var_test.get("new_type") == "1" and var_test.get('pack')[0]['search'] != "":
                        my_product = []
                        for i in range(1,var_test.get('pack_produit_nb')):
                            my_product.append((ui.find_element(ui.def_object(self._objects['pack_product_name'],i)[0],ui.def_object(self._objects['pack_product_name'],i)[1]).text).split('Size')[0] + "||" + (ui.find_element(ui.def_object(self._objects['pack_product_quantity'],i)[0],ui.def_object(self._objects['pack_product_quantity'],i)[1]).text).split('x')[1])                        
                        for j in range(1,var_test.get('pack_produit_nb')):
                            Test.assert_equals(var_test.get('pack_product_name_' + str(j)).strip().encode('utf8') ,my_product[j-1].split('||')[0].strip().encode('utf8') , "'pack_product_name_" +  str(j) + " not matching", "'pack_product_name_" + str(j) + " is ok")
                            Test.assert_equals(var_test.get('pack_product_quantity_' + str(j)),my_product[j-1].split('||')[1]  , "'pack_product_quantity_" +  str(j) + " not matching", "'pack_product_quantity_" +  str(j) + " is ok")
                    
                    ui.click(self._objects['product_new_info_resume'])
                    Context().browser.switch_to_frame("form_step1_description_short_1_ifr")
                    Test.assert_equals(var_test.get('resume'), ui.find_element(self._objects['product_new_info_resume_document'][0],self._objects['product_new_info_resume_document'][1]).text, "'resume' not matching", "resume is ok")
                    Context().browser.switch_to_default_content()
                    ui.click(self._objects['product_new_info_desc'])
                    Context().browser.switch_to_frame("form_step1_description_1_ifr")
                    Test.assert_equals(var_test.get('desc'), ui.find_element(self._objects['product_new_info_desc_document'][0],self._objects['product_new_info_desc_document'][1]).text, "'desc' not matching", "resume is ok")
                    Context().browser.switch_to_default_content()
                    ...
                    if "//" in var_test.get("picture"):
                        ...
                        while j < var_test.get('nb_img'):
                            Test.assert_equals(img_data_id[j], check_data_id[j], "data_id of the picture are not the same, please check the picture saved")
                            j=j+1
                    if var_test.get("new_type") == "0" and var_test.get('variation')=="" or  var_test.get("new_type") != "0":
                        Test.assert_equals(var_test.get("quantity"), ui.get_attribute(self._objects["product_new_quantity_quantity_shortcut"],"value"), "'quantity' not matching", "'quantity' is ok")     
                    check_price = var_test.get("priceTE")
                    if "." not in check_price:
                        check_price = check_price + ".000000"
                    Test.assert_equals(check_price, ui.get_attribute(self._objects["product_new_sell_price_ht_shortcut"],"value"), "'priceTE' not matching", "'priceTE' is ok") 
                    
                    if var_test.get("new_type") == "0" and var_test.get('variation')!="":
                        Test.assert_equals("true", ui.get_attribute(ui.def_object(self._objects['product_new_activate_variation'],1),"checked"), "'priceTE' not matching", "'priceTE' is ok") 

                    Test.assert_equals(var_test.get('manufacturer_check'), ui.find_element(self._objects['product_manufacturer_check'][0],self._objects['product_manufacturer_check'][1]).text, "'product_manufacturer' not matching", "'product_manufacturer' is ok")
                    ...
                    if var_test.get('search_related_products')!= "": 
                        if "//" in var_test.get("search_related_products"):
                            ...
                            while i < var_test.get('related_product_number'):
                                ...
                                Test.assert_equals(str(var_test.get('related_product_name_' + str(i)).encode('utf8')).split(" (")[0], str(ui.get_text((related_product[0],related_product[1])).encode('utf8')).split(" (")[0], "'related_product' not matching", "'related_product' is ok")
                                i=i+1
                        else:
                            related_product=ui.def_object(self._objects['related_product_info'],1)
                            Test.assert_equals(var_test.get('related_product_name_1'), ui.get_attribute((related_product[0],related_product[1]), "value"), "'related_product' not matching", "'related_product' is ok")
        
                    if var_test.get('features')!="":
                        v = 0
                        for x_feature in var_test.get('features'):
                            feature_selected = ui.def_object(self._objects['feature_selected'],v)
                            Test.assert_equals(x_feature['feature'], ui.get_attribute((feature_selected[0],feature_selected[1]), "value"), "'feature_selected' not matching", "'feature_selected' is ok")
                            
                            if x_feature['value'] != "":
                                feature_value = ui.def_object(self._objects['feature_value'],v)
                                Test.assert_equals(x_feature['value'], ui.get_attribute((feature_value[0],feature_value[1]), "value"), "'feature_value' not matching", "'feature_value' is ok")
                            else:
                                feature_value = ui.def_object(self._objects['feature_custom_value'],v)
                                Test.assert_equals(x_feature['custom_value'], ui.get_attribute((feature_value[0],feature_value[1]), "value"), "'feature_value' not matching", "'feature_value' is ok")
                            v = v+1
                    ...
                    if var_test.get("new_type") == "2":
                        if var_test.get("virtual_file") != "":
                            Test.assert_equals("true", ui.get_attribute(self._objects["product_new_virtual_file_yes"],"checked"), "'virtual file attached' not matching", "'virtual file attached' is ok")               
                            Test.assert_equals(var_test.get("virtual_file")[0]['virtual_file'], ui.get_attribute(self._objects["product_new_virtual_file_name"],"value"), "'virtual_file_name' not matching", "'virtual_file_name' is ok")
                            Test.assert_equals(var_test.get("virtual_file")[0]['virtual_file_nb_download'], ui.get_attribute(self._objects["product_new_virtual_file_nb_download"],"value"), "'virtual_file_nb_download' not matching", "'virtual_file_nb_download' is ok")
                            Test.assert_equals(var_test.get("virtual_file")[0]['file_nb_days'], ui.get_attribute(self._objects["product_new_virtual_file_nb_days"],"value"), "'file_nb_days' not matching", "'file_nb_days' is ok")
                        else:
                            Test.assert_equals("true", ui.get_attribute(self._objects["product_new_virtual_file_no"],"checked"), "'virtual file attached' not matching", "'virtual file attached' is ok") 
                            
                    if var_test.get('variation')!="":
                        v = 1
                        for x_variation in var_test.get('variation'): 
                            quantity_var = ui.def_object(self._objects['product_new_variation_line_quantity'],v)
                            Test.assert_equals(x_variation['quantity'], ui.get_attribute((quantity_var[0],quantity_var[1]),"value"), "'quantity variation' not matching", "'quantity variation' is ok")
                            v =v+1
                    else:
                        Test.assert_equals(var_test.get("quantity"), ui.get_attribute(self._objects['product_new_quantity_quantity'],"value"), "'quantity' not matching", "'quantity' is ok")

                    if var_test.get("new_type") == "1" and var_test.get('pack')[0]['search'] != "" :
                        Test.assert_equals(var_test.get("quantity_pack"), ui.get_attribute((self._objects['product_new_pack_quantity_check'][0],self._objects['product_new_pack_quantity_check'][1]), 'value'), "'quantity_pack' not matching", "'quantity_pack' is ok")   
                    if var_test.get("new_type") != "0" or var_test.get("new_type") == "" and var_test.get('variation')=="":
                        Test.assert_equals(var_test.get('qty_min'), ui.get_attribute(self._objects["product_new_quantity_minimum"],"value"), "'qty_min' not matching", "'qty_min' is ok")
                    ...
                    if var_test.get("new_type") != "2":
                        ui.click(self._objects['product_new_carrier_tab'])
                        Test.assert_equals(var_test.get('cwidth'), ui.get_attribute(self._objects["product_new_carrier_width"],"value"), "'cwidth' not matching", "'cwidth' is ok")
                        Test.assert_equals(var_test.get('cheight'), ui.get_attribute(self._objects["product_new_carrier_height"],"value"), "'cheight' not matching", "'cheight' is ok")
                        Test.assert_equals(var_test.get('cdepth'), ui.get_attribute(self._objects["product_new_carrier_depth"],"value"), "'new_type' not matching", "'cdepth' is ok")
                        Test.assert_equals(var_test.get('cweight'), ui.get_attribute(self._objects["product_new_carrier_weight"],"value"), "'cweight' not matching", "'cweight' is ok")
                        ...
                        Test.assert_equals(str(cadd_ship_coast_check), str(ui.get_attribute(self._objects["product_new_carrier_add_ship_coast"],"value")), "'cadd_ship_coast' not matching", "'cadd_ship_coast' is ok")
                        carrier_check = ui.def_object(self._objects['product_new_carrier_check'],var_test.get("carrier"))
                        Test.assert_equals("true", ui.get_attribute((carrier_check[0],carrier_check[1]),"checked"), "'product_new_carrier' not matching", "'product_new_carrier' is ok")                            

                    ui.click(self._objects['product_new_prices'])    
                    check_price = var_test.get("priceTE")
                    if "." not in check_price:
                        check_price = check_price + ".000000"
                    Test.assert_equals(check_price, ui.get_attribute(self._objects["product_new_sell_price_ht"],"value"), "'priceTE' not matching", "'priceTE' is ok")  
                    if var_test.get('on_sale') == "0": 
                        Test.assert_equals("None", str(ui.get_attribute(self._objects['product_new_price_on_sale'],"checked")), "'product_new_carrier' not matching", "'product_new_carrier' is ok")
                    else:
                        Test.assert_equals("true", ui.get_attribute(self._objects['product_new_price_on_sale'],"checked"), "'product_new_carrier' not matching", "'product_new_carrier' is ok")             

                    wholesale = var_test.get('wholesale')
                    if "." not in wholesale:
                        wholesale = wholesale + ".000000"
                    Test.assert_equals(wholesale, ui.get_attribute(self._objects["product_new_price_ht"],"value"), "'wholesale' not matching", "'wholesale' is ok")
                    Test.assert_equals(var_test.get('unity'), ui.get_attribute(self._objects["product_new_price_unity_ht"],"value"), "'unity' not matching", "'unity' is ok")

                    
                    ui.click(self._objects['product_new_ref'])
                    Test.assert_equals(var_test.get('metatitle'), ui.get_attribute((self._objects['product_new_ref_title'][0],self._objects['product_new_ref_title'][1]), 'value'), "'metatitle' not matching", "'metatitle' is ok")
                    Test.assert_equals(var_test.get('metadesc'), ui.get_attribute((self._objects['product_new_ref_desc'][0],self._objects['product_new_ref_desc'][1]), 'value'), "'metadesc' not matching", "'metadesc' is ok")
                    Test.assert_equals(var_test.get('shortlink'), ui.get_attribute((self._objects['product_new_ref_url'][0],self._objects['product_new_ref_url'][1]), 'value'), "'shortlink' not matching", "'shortlink' is ok")
                    

                    ui.click(self._objects['product_new_options'])
                    Test.assert_equals(var_test.get('upc'), ui.get_attribute(self._objects["product_new_info_upc"],"value"), "'upc' not matching", "'upc' is ok")
                    Test.assert_equals(var_test.get('ean13'), ui.get_attribute(self._objects["product_new_info_ean13"],"value"), "'ean13' not matching", "'ean13' is ok")
                    Test.assert_equals(var_test.get('isbn'), ui.get_attribute(self._objects["product_new_info_isbn"],"value"), "'isbn' not matching", "'isbn' is ok")
                    Test.assert_equals(var_test.get('ref'), ui.get_attribute(self._objects["product_new_info_ref"],"value"), "'ref' not matching", "'ref' is ok")
                    if var_test.get("new_type") != "2":
                        Test.assert_equals(var_test.get("condition"), ui.get_attribute((self._objects['product_new_condition_check'][0],self._objects['product_new_condition_check'][1]), 'value'), "'condition' not matching", "'condition' is ok")
                    else:    
                        Test.assert_equals("new", ui.get_attribute((self._objects['product_new_condition_check'][0],self._objects['product_new_condition_check'][1]), 'value'), "'condition' not matching", "'condition' is ok")
                   
                    Test.assert_equals(var_test.get('visibility'), ui.get_attribute(self._objects["new_product_visibility_check"],"value"), "'visibility' not matching", "'visibility' is ok")
                    Test.assert_equals("true", ui.get_attribute(self._objects["product_new_options_avalaible_orders"],"checked"), "'avalaible_orders' not matching", "'avalaible_orders' is ok")               
                    Test.assert_equals("true", ui.get_attribute(self._objects["product_new_options_show_price"],"checked"), "'show_price' not matching", "'show_price' is ok")               
                    Test.assert_equals("true", ui.get_attribute(self._objects["product_new_options_online_only"],"checked"), "'online_only' not matching", "'online_only' is ok")               
                    Test.assert_equals("true", ui.get_attribute(self._objects["product_new_options_suppliers"],"checked"), "'options_suppliers' not matching", "'options_suppliers' is ok")               
                    Test.assert_equals(var_test.get('default_supplier'), ui.get_attribute(self._objects["new_product_default_supplier_check"],"value"), "'default_supplier' not matching", "'default_supplier' is ok")
                    ...
                    if var_test.get('variation')!="":
                        ...
                        for x_variation in var_test.get('variation'):
                            if x_variation['supplier_reference'] != "":
                                supp_ref = ui.def_object(self._objects['product_new_options_supplier_reference'],v)
                                Test.assert_equals(x_variation['supplier_reference'],ui.get_attribute((supp_ref[0],supp_ref[1]), "value"), "'supplier_reference' not matching", "'supplier_reference' is ok")
                            else:
                                product = ui.def_object(self._objects['product_new_supplier_name_product'],v+1)
                                name_product = ui.get_text(product)
                                supp_ref = ui.def_object(self._objects['product_new_options_supplier_reference'],v)
                                Test.assert_equals(name_product,ui.get_attribute((supp_ref[0],supp_ref[1]), "value"), "'supplier_reference' not matching", "'supplier_reference' is ok")
                            supp_price = ui.def_object(self._objects['product_new_options_product_price'],v)
                            ...
                            Test.assert_equals(supplier_product_price,ui.get_attribute((supp_price[0],supp_price[1]),"value"), "'supplier_product_price' not matching", "'supplier_product_price' is ok")
                            currency = ui.def_object(self._objects['product_new_options_price_currency_check'],v,x_variation['supplier_product_price_currency'])
                            Test.assert_equals(x_variation['supplier_product_price_currency'], ui.get_attribute((currency[0],currency[1]),"value"), "'default_supplier' not matching", "'default_supplier' is ok")
                            v = v+1
                    else:
                        if var_test.get('supplier_reference') != "":
                            supp_ref = ui.def_object(self._objects['product_new_options_supplier_reference'],0)
                            Test.assert_equals(var_test.get('product_name'),ui.get_attribute((supp_ref[0],supp_ref[1]), "value"), "'supplier_reference' not matching", "'supplier_reference' is ok")
                        else:
                        ...
                        Test.assert_equals(var_test.get('price_currency'), ui.get_attribute((currency[0],currency[1]),"value"), "'default_supplier' not matching", "'default_supplier' is ok")
                        
                    if var_test.get('personalization')!="":
                        v = 0
                        for x_perso in var_test.get('personalization'):
                            name = ui.def_object(self._objects['product_new_personalization_name'],v)
                            Test.assert_equals(x_perso['name'],ui.get_attribute((name[0],name[1]), "value"), "'product_new_personalization_name' not matching", "'product_new_personalization_name' is ok")
                            my_type = ui.def_object(self._objects['product_new_personalization_type'],v,x_perso['type'])
                            Test.assert_equals(x_perso['type'], ui.get_attribute((my_type[0],my_type[1]),"value"), "'default_supplier' not matching", "'default_supplier' is ok")
                            mandatory = ui.def_object(self._objects['product_new_personalization_mandatory'],v)
                            if x_perso['mandatory'] == str(1):
                                Test.assert_equals("true", ui.get_attribute((mandatory[0],mandatory[1]),"checked"), "'mandatory' not matching", "'mandatory' is ok")
                            else:
                                Test.assert_equals("None", str(ui.get_attribute((mandatory[0],mandatory[1]),"checked")), "'mandatory' not matching", "'mandatory' is ok")
                            v = v +1
        ...
        for col in var_test.get("col_search").split("//"):
            try:
                ...
                while int(current_element_number) <= int(nb_element):
                    if  col.split('||')[1] == "1":
                        product_list.append(int(ui.find_element(ui.def_object(self._objects['col_line_product_table_first_column'],current_element_number,1)[0],ui.def_object(self._objects['col_line_product_table_first_column'],current_element_number,1)[1]).text))
                    elif col.split('||')[1] == "6":
                        element_value=ui.get_text(ui.def_object(self._objects['col_line_product_table'],current_element_number, col.split('||')[1])).split(' ')[0].replace(',','.')
                        product_list.append(float(element_value))
                    elif col.split('||')[1] == "8":
                        product_list.append(int(ui.get_text(ui.def_object(self._objects['col_line_product_table'],current_element_number, col.split('||')[1]))))
                    elif col.split('||')[1] == "9":
                        product_list.append(ui.get_attribute(ui.def_object(self._objects['col_line_product_table_activate'],current_element_number, col.split('||')[1]), "onClick"))
                    else:
                        product_list.append(ui.get_text(ui.def_object(self._objects['col_line_product_table'],current_element_number, col.split('||')[1])))
